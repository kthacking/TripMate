...
<div style="max-width: 900px; animation: slideIn 0.4s ease-out;">
    <div style="margin-bottom: 25px;">
        <h3
            style="font-size: 1.25rem; font-weight: 850; color: var(--admin-text-main); letter-spacing: -0.6px; margin-bottom: 5px;">
            System Configuration Core</h3>
        <p style="color: var(--admin-text-muted); font-weight: 500; font-size: 0.9rem;">Manage global environment
            variables and platform-wide feature permissions.</p>
    </div>
    ...
    <form method="POST">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <!-- General Settings -->
            <div
                style="background: white; border-radius: 12px; padding: 20px; box-shadow: var(--shadow-sm); border: 1px solid #E5E7EB;">
                <h4
                    style="font-size: 0.95rem; color: #4338CA; border-bottom: 1px solid #F3F4F6; padding-bottom: 12px; margin-bottom: 15px;">
                    Environment Profile</h4>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group">
                        <label class="form-label" style="font-size: 0.85rem;">Platform Title</label>
                        <input type="text" name="s[site_title]"
                            value="<?php echo htmlspecialchars($s['site_title']); ?>" class="form-control"
                            style="height: 40px; border-radius: 10px; font-size: 0.9rem;">
                    </div>
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" name="s[maintenance_mode]" value="1" <?php if ($s['maintenance_mode'] == '1')
                                echo 'checked'; ?>>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" name="s[registration_enabled]" value="1" <?php if ($s['registration_enabled'] == '1')
                                echo 'checked'; ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" name="s[media_uploads_enabled]" value="1" <?php if ($s['media_uploads_enabled'] == '1')
                                echo 'checked'; ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" name="s[zip_downloads_enabled]" value="1" <?php if ($s['zip_downloads_enabled'] == '1')
                                echo 'checked'; ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" name="s[auto_approval]" value="1" <?php if ($s['auto_approval'] == '1')
                                echo 'checked'; ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
            ...
            <div
                ...
                <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <input type="number" name="s[max_upload_size_mb]"
                        value="<?php echo htmlspecialchars($s['max_upload_size_mb']); ?>" class="form-control"
                        style="width: 100px; height: 40px; border-radius: 10px; font-size: 0.9rem;">
                </div>
            </div>

            <button type="submit" class="btn-premium"
                style="margin-top: 5px; width: 100%; justify-content: center; height: 45px; font-size: 0.95rem;">
